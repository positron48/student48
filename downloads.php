...
<?
    ...
    $material = $dbWorker->query("SELECT title_material, metakey, link, filesize, downloads, dateadd, title_predmet, semestr FROM materials M INNER JOIN predmets P ON M.predmetid=P.id WHERE M.id=$id")->fetch(); 
?>
	<title>
...
<? require($_SERVER['DOCUMENT_ROOT']."/include/header.php"); ?>
    ...
    <?
        ...
        $dbWorker->query("UPDATE materials SET downloads='$downloads' WHERE id='$id'");
    ?>
    </center>
